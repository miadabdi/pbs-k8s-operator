...
// PBSBackupReconciler reconciles a PBSBackup object
type PBSBackupReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

// +kubebuilder:rbac:groups=pbs.pbs.sharifmind.ir,resources=pbsbackups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=pbs.pbs.sharifmind.ir,resources=pbsbackups/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=pbs.pbs.sharifmind.ir,resources=pbsbackups/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the PBSBackup object against the actual cluster state, and then
